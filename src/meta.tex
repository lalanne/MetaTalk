...
\setmonofont[ItalicFont={OpenSans Italic},BoldFont={OpenSans Bold},BoldItalicFont={OpenSans Bold Italic},Ligatures=TeX]{OpenSans}%
...
\date[June 5, 2014] % (optional, should be abbreviation of conference nam
{Dublin\ June 5, 2014}
