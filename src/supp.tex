    ...
    \begin{columns}[T]
        \begin{column}[T]{5cm}
            \inputminted[mathescape,
                       ...
                       linenos,
                       framesep=1mm]{c++}
                       {/Users/lalanne/MyCode/GitHubProjects/MetaTalk/src/code/dd_c1.cpp} 
        \end{column}
        \begin{column}[T]{5cm}
            \inputminted[mathescape,
                   linenos,
                   ...
                   linenos,
                   framesep=1mm]{c++}
                   {/Users/lalanne/MyCode/GitHubProjects/MetaTalk/src/code/dd_c12.cpp}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[T]
        \begin{column}[T]{5cm}
            \inputminted[mathescape,
                       ...
                       linenos,
                       framesep=1mm]{c++}
                       {/Users/lalanne/MyCode/GitHubProjects/MetaTalk/src/code/dd_c2.cpp} 
        \end{column}
        \begin{column}[T]{5cm}
            \inputminted[mathescape,
                   linenos,
                   ...
                   linenos,
                   framesep=1mm]{c++}
                   {/Users/lalanne/MyCode/GitHubProjects/MetaTalk/src/code/dd_c21.cpp}
        \end{column}
    \end{columns}
\end{frame}
